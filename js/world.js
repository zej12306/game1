...
if (typeof window !== 'undefined') {
  ...
  window.WEATHER_EFFECT = WEATHER_EFFECT;
  window.LIFESPAN_TABLE = LIFESPAN_TABLE;
  window.LIFESPAN_EXTEND = LIFESPAN_EXTEND;
  window.PERIODIC_EVENTS = PERIODIC_EVENTS;
  window.DISTANCE_TABLE = DISTANCE_TABLE;
  window.TELEPORT_NETWORK = TELEPORT_NETWORK;
  window.BIDDER_TYPES = BIDDER_TYPES;
  window.BID_TACTICS = BID_TACTICS;
  window.BLACK_MARKETS = BLACK_MARKETS;
  window.BLACK_MARKET_VIP = BLACK_MARKET_VIP;
  window.BLACK_MARKET_DISCOVERY = BLACK_MARKET_DISCOVERY;
  window.PRICE_FACTORS = PRICE_FACTORS;
}
