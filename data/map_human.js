  ...
  regions: [
    ...
    // ===== 越国七派（练气解锁）=====
    {
      ...
      nodes: [
        ...
        { id: 'hf_backhill', name: '后山', type: 'wild', huntNode: true,
    ...
    },
    {
      ...
      nodes: [
        ...
        { id: 'ym_secret', name: '禁地', type: 'secret', huntNode: true,
    ...
    },
    {
      ...
      nodes: [
        ...
        { id: 'qx_pond', name: '灵泉', type: 'wild', huntNode: true,
    ...
    },
    {
      ...
      nodes: [
        ...
        { id: 'gj_arena', name: '试剑台', type: 'special', huntNode: true,
...
{ id: 'tq_main', name: '天阙宫', type: 'guild',
        ...
        { id: 'tq_cliff', name: '九龙崖', type: 'wild', huntNode: true,
...
{ id: 'ls_main', name: '灵兽殿', type: 'guild',
        ...
        { id: 'ls_valley', name: '万兽谷', type: 'wild', huntNode: true,
...
{ id: 'hd_main', name: '化刀殿', type: 'guild',
          events: { explore: 0.10, special: 0.10, fight: 0.10, loot: 0.20, nothing: 0.40, secret: 0.10 } },
        { id: 'hd_cliff', name: '断刃崖', type: 'wild', huntNode: true,
    ...
    // ===== 元武国（筑基解锁）=====
    {
      ...
      nodes: [
        ...
        { id: 'yw_arena', name: '角斗场', type: 'special', huntNode: true,
    ...
    // ===== 极西之地（金丹解锁）=====
    {
      ...
      nodes: [
        ...
        { id: 'wx_blood', name: '血炼渊', type: 'secret', huntNode: true,
    ...
    // ===== 乱星海（金丹解锁）=====
    {
      ...
      nodes: [
        ...
        { id: 'ss_outer', name: '外星海', type: 'wild', huntNode: true,
    ...
    // ===== 天南大陆（元婴解锁）=====
    {
      ...
      nodes: [
        ...
        { id: 'tn_beast', name: '妖兽山脉', type: 'wild', huntNode: true,
    ...
    // ===== 大晋（化神解锁）=====
    {
      ...
      nodes: [
        ...
        { id: 'dj_battlefield', name: '正魔战场', type: 'special', huntNode: true,
    ...
    // ===== 昆吾山（隐藏，元婴+）=====
    {
      ...
      discoverChance: 0.02,
      nodes: [
        { id: 'kw_ruin', name: '上古遗迹', type: 'secret', huntNode: true,
...
function getExploreResult(node) {
  ...
  // 负面
  if (Math.random() < 0.03) {
    const loss = Math.floor(GameState.spiritStones * SPIRIT_STONES.source.explore.lossRatio.human);
