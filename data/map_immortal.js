  ...
  regions: [
    ...
    // ===== 飞升台（真仙解锁）=====
    {
      ...
      nodes: [
        ...
        { id:'ia_spring',name:'仙灵泉',type:'cave',huntNode:true,
    ...
    // ===== 金阙仙宫（金仙解锁）=====
    {
      ...
      nodes: [
        ...
        { id:'ig_pill',name:'仙丹阁',type:'special',
          ...
          nodeSpecial:{name:'仙丹',rate:0.06,effect:()=>{applyLifespan(GameState,200);addLog('仙丹阁中获赐仙丹，寿元+200！','crit');}}},
        ...
        { id:'ig_guard',name:'金甲卫营',type:'special',huntNode:true,
        ...
        { id:'ig_orchard',name:'仙界果园',type:'wild',
          ...
          nodeSpecial:{name:'仙桃',rate:0.08,effect:()=>{applyLifespan(GameState,100);GameState.vit+=2;addLog('仙界果园中吃到仙桃，寿元+100，体魄+2！','success');}}},
      ],
    },
    ...
    // ===== 太乙道场（太乙解锁）=====
    {
      ...
      nodes: [
        ...
        { id:'it_rift',name:'时空裂隙',type:'secret',huntNode:true,
    ...
    // ===== 大罗天域（大罗解锁）=====
    {
      ...
      nodes: [
        ...
        { id:'id_mountain',name:'不周山',type:'wild',huntNode:true,
    ...
    // ===== 道祖圣境（道祖解锁）=====
    {
      ...
      nodes: [
        ...
        { id:'iz_void',name:'万物归墟',type:'special',huntNode:true,
    ...
    // ===== 开天秘境（隐藏，太乙+）=====
    {
      ...
      nodes: [
        ...
        { id:'gs_void',name:'虚无之渊',type:'secret',huntNode:true,
...
function IMMORTAL_getExploreResult(node) {
  ...
  // 负面
  if (Math.random() < 0.03) {
    const loss = Math.floor(GameState.spiritStones * SPIRIT_STONES.source.explore.lossRatio.immortal);
