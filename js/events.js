...
if (typeof window !== 'undefined') {
  ...
  window.WILD_EVENTS = WILD_EVENTS;
  window.SECRET_EVENTS = SECRET_EVENTS;
  window.TOWN_EVENTS = TOWN_EVENTS;
  window.FACTION_EVENTS = FACTION_EVENTS;
  window.DANGER_EVENTS = DANGER_EVENTS;
  window.TRIBULATION_EVENTS = TRIBULATION_EVENTS;
  window.EVENT_CHAINS = EVENT_CHAINS;
  window.DYNAMIC_CONDITIONS = DYNAMIC_CONDITIONS;
  window.MAIN_QUEST = MAIN_QUEST;
