...
if (typeof window !== 'undefined') {
  ...
  window.POOLS_EXPLORATION = POOLS;
  window.POOL_KEYS_EXPLORATION = POOL_KEYS;
  window.DANGER_EVENT_POOL = DANGER_EVENT_POOL;
  window.TRIBULATION_CHAIN = TRIBULATION_CHAIN;
