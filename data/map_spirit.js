  ...
  regions: [
    ...
    // ===== 冰封大陆（炼虚解锁）=====
    {
      ...
      nodes: [
        ...
        { id:'si_glacier',name:'万年冰川',type:'wild',
    ...
    // ===== 木族领地（合体解锁）=====
    {
      ...
      nodes: [
        ...
        { id:'sw_forest',name:'神木林',type:'wild',
    ...
    // ===== 血光圣殿（合体解锁）=====
    {
      ...
      nodes: [
        ...
        { id:'sb_prison',name:'血狱',type:'secret',
    ...
    // ===== 雷鸣大陆（大乘解锁）=====
    {
      ...
      nodes: [
        ...
        { id:'sr_valley',name:'雷鸣峡谷',type:'wild',
    ...
    // ===== 飞灵族圣地（大乘解锁）=====
    {
      ...
      nodes: [
        ...
        { id:'sf_temple',name:'飞灵圣殿',type:'secret',
    ...
    // ===== 灵墟古迹（隐藏，合体+）=====
    {
      ...
      nodes: [
        { id:'rl_ruin',name:'上古灵墟',type:'secret',
...
function SPIRIT_getExploreResult(node) {
  ...
  // 负面
  if (Math.random() < 0.04) {
    const loss = Math.floor(GameState.spiritStones * 0.08);
